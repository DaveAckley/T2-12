/*
 * FB driver for the ILI9486 LCD Controller as used in the T2 Tile
 *
 * Based on fb_ili9486.c
 * Modifications are 
 * Copyright (C) 2019 The T2 Tile Project
 *
 * Sat Dec 14 04:16:51 2019 I KNOW I HAVE TO CHANGE THE NAME OF THIS
 * THING BUT I'M SO CLUELESS ABOUT KConfig OR WHATEVER I DON'T KNOW
 * HOW TO GET IT TO COMPILE IF I DO CHANGE THE NAME!
 *
